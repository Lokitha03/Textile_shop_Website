...
//             <Link to="/">
//               <img width="150px" alt='Sri Sai Collections' src="/images/logo.png" />
//             </Link>
//             </div>
//         </div>
    ...
    return (
        <nav className="navbar row">
            ...
            <div className="col-12 col-md-3 mt-4 mt-md-0 text-center">
                {isAuthenticated ? (
                    <Dropdown className='d-inline'>
                        ...
                        <Dropdown.Menu>
                            ...
                            <Dropdown.Item onClick={() => navigate('/contact')} className='text-dark'>
                                Contact 
                            </Dropdown.Item>
                ...
                {/* Cart - show only for authenticated non-admin users */}
